...
describe('protocolProfileBehavior', function () {
    ...
    describe('with noCacheHeader: true', function () {
        var URL = HOST + '/1/302';
        ...
        it('should have `Cache-Control: no-cache` header in request', function () {
    ...
    describe('with noCacheHeader: false', function () {
        var URL = HOST + '/1/302';
        ...
        it('should not have `Cache-Control: no-cache` header in request', function () {
            var request = testrun.request.getCall(0).args[3].toJSON();
    ...
    describe('with noCacheHeader: undefined', function () {
        var URL = HOST + '/1/302';
    ...
    describe('with postmanTokenHeader: true', function () {
        var URL = HOST + '/1/302';
        ...
        it('should have postman-token header in request', function () {
            var request = testrun.request.getCall(0).args[3].toJSON(),
    ...
    describe('with postmanTokenHeader: false', function () {
        var URL = HOST + '/1/302';
        ...
        it('should not have postman-token header in request', function () {
            var request = testrun.request.getCall(0).args[3].toJSON(),
            ...
            expect(header).not.be.empty;
        });
    });

    describe('with postmanTokenHeader: undefined', function () {
        var URL = HOST + '/1/302';
