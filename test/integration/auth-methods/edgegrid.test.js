...
describe('EdgeGrid auth', function () {
    ...
    describe('with missing credentials', function () {
        ...
        it('should have sent the request once', function () {
            ...
            expect(response).to.have.property('code').that.is.oneOf([200, 401]);
        });

        it('should not have passed the EdgeGrid authorization', function () {
            expect(testrun).to.nested.include({
                'request.callCount': 1
            });
    ...
    describe('with correct credentials', function () {
        ...
        it('should include correct Authorization header', function () {
            ...
            expect(header).to.have.have.property('value').that.include(`client_token=${credentials.clientToken}`);
            expect(header).to.have.have.property('value').that.include(`access_token=${credentials.accessToken}`);
            expect(header).to.have.have.property('value').that.include('signature=');
            expect(header).to.have.have.property('value').that.match(nonceRegex);
            expect(header).to.have.have.property('value').that.match(timestampRegex);
        });
        ...
        it('should have passed the EdgeGrid authorization', function () {
            expect(testrun).to.nested.include({
                'request.callCount': 1
            });
    ...
    describe('with wrong credentials', function () {
        ...
        it('should include correct Authorization header', function () {
            ...
            expect(header).to.have.have.property('key', 'Authorization');
            expect(header).to.have.have.property('value').that.include(`client_token=${wrongCrededntials.clientToken}`);
            expect(header).to.have.have.property('value').that.include(`access_token=${wrongCrededntials.accessToken}`);
            expect(header).to.have.have.property('value').that.include('signature=');
            expect(header).to.have.have.property('value').that.match(nonceRegex);
            expect(header).to.have.have.property('value').that.match(timestampRegex);
        });
        ...
        it('should have failed the EdgeGrid authorization', function () {
            expect(testrun).to.nested.include({
                'request.callCount': 1
            });
