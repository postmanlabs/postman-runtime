var _ = require('lodash'),
     ...
     * @param options
     * @param hostsOptions
     * @param hostsOptions.type
     * @param hostsOptions.hostIpMap
     * @param hostname
     * @param callback
     */
    _lookup = function (options, hostsOptions, hostname, callback) {
        var hostIpMap,
            resolvedFamily = 4,
            resolvedAddr;
    ...
    lookup = function (lookupOptions, hostname, options, callback) {
        var self = this,
            ...
            hostOptions = networkOpts.hosts;

        if (lowercaseHost !== LOCALHOST) {
            return _lookup(options, hostOptions, lowercaseHost, function (err, addr, family) {
