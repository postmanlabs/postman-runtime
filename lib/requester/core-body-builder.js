...
module.exports = {
     ...
     */
    raw (content, request) {
        const contentLanguage = _.get(request, 'body.options.raw.language', 'text');
        ...
        if (request && oneNormalizedHeader(request.headers, CONTENT_TYPE_HEADER_KEY)) {
            contentTypeHeader = oneNormalizedHeader(request.headers, CONTENT_TYPE_HEADER_KEY);
        }
        ...
        if (contentTypeHeader &&
            ...
            content = stripJSONComments(content, { whitespace: false });
        }
