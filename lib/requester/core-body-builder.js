...
formDataBodyReducer = function (data, param) {
    ...
    if (formParam.value &&
        (typeof formParam.value === 'object' || typeof formParam.value === 'function') &&
        typeof formParam.value.pipe !== 'function') {
        formParam.value = formParam.value.toString === 'function' ? formParam.value.toString() : E;
    }
