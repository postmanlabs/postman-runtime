    ...
    request: function (id, request, protocolProfileBehavior, callback) {
        ...
        return requests(request, requestOptions, onStart, function (err, res, resBody, debug) {
            ...
            if (err) {
                ...
                //
                // Also sending `history` object to enable consumers to
                // reliably figure out if session was created, hence enabling them to
                // know whether it was a Request Error or Response Error.
                return onEnd(err, null, history);
            }
