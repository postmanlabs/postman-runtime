...
var dns = require('dns'),
    ...
    addSystemHeaders = function (request, options, disabledHeaders, systemHeaders) {
        ...
        [
            ...
            // @note: Using crypto.randomUUID() for Postman-Token header to maintain UUID v4 format compatibility
            // (external systems may parse this header and expect UUID format)
