...
module.exports = {
     ...
     * @returns {{}}
     */
    getRequestOptions: function (item, defaultOpts) {
        var options = {},
        ...
        // add protocolProfileBehavior options to defaultOpts
        defaultOpts.protocolProfileBehavior = item.protocolProfileBehavior;
    ...
    getRequestBody: function (request, options) {
        ...
        var requestBody = request.body,
            ...
            disableBodyPruning = _.get(options, 'protocolProfileBehavior.disableBodyPruning'),

            // flag to decide bodyPruning for METHODS_WITHOUT_BODY
            // @note this will be `true` even if protocolProfileBehavior is undefined
            bodyPruning = !disableBodyPruning;
        ...
        // bail out if request method doesn't support body and bodyPruning is true.
        ...
        if (METHODS_WITHOUT_BODY[requestMethod] && !_.isNil(disableBodyPruning) && bodyPruning) {
            return;
        }
        ...
        if (requestMethod === GET && bodyPruning && options && !options.sendBodyWithGetRequests) {
            return;
        }
