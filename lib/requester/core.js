...
module.exports = {
    ...
    getRequestOptions: function (request, defaultOpts, protocolProfileBehavior) {
        ...
        var options = {},
            ...
            url = urlEncoder.toNodeUrl(request.url, disableUrlEncoding),
        ...
        // use custom URL parser to respect the `disableUrlEncoding` option
        options.urlParser = {
            ...
            resolve: function (base, relative) {
                if (typeof base === STRING) {
                    // we parse base URL here to respect `disableUrlEncoding`
