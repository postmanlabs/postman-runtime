...
module.exports = {
     ...
     * @param defaultOpts.cacheControlHeader
    ...
    getRequestOptions: function (request, defaultOpts, protocolProfileBehavior) {
        ...
        defaultOpts.cacheControlHeader && self.ensureHeaderExists(options.headers, 'Cache-Control', 'no-cache');
        defaultOpts.postmanTokenHeader && self.ensureHeaderExists(options.headers, 'Postman-Token', uuid.v4());
