...
module.exports = {
     ...
     * @param defaultOpts.sendNoCacheHeader
     * @param defaultOpts.sendPostmanTokenHeader
    ...
    getRequestOptions: function (request, defaultOpts, protocolProfileBehavior) {
        ...
        defaultOpts.sendNoCacheHeader && self.ensureHeaderExists(options.headers, 'Cache-Control', 'no-cache');
        defaultOpts.sendPostmanTokenHeader && self.ensureHeaderExists(options.headers, 'Postman-Token', uuid());
