...
module.exports = {
    ...
    getRequestOptions: function (request, defaultOpts, protocolProfileBehavior) {
        ...
        options.noCacheHeader = defaultOpts.noCacheHeader;
        options.postmanTokenHeader = defaultOpts.postmanTokenHeader;
        ...
        options.noCacheHeader && self.ensureHeaderExists(options.headers, 'Cache-Control', 'no-cache');
        options.postmanTokenHeader && self.ensureHeaderExists(options.headers, 'Postman-Token', uuid.v4());
