var _ = require('lodash'),
     ...
     * @type {Object}
     */
    OPTIONS_WITH_PROTOCOL_PROFILE_BEHAVIOR = {
...
module.exports = {
    ...
    getRequestOptions: function (request, defaultOpts, protocolProfileBehavior) {
        ...
        for (reqOption in OPTIONS_WITH_PROTOCOL_PROFILE_BEHAVIOR) {
            behaviorName = OPTIONS_WITH_PROTOCOL_PROFILE_BEHAVIOR[reqOption];
