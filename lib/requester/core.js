var _ = require('lodash'),
     ...
     * @returns {*} - Resolved protocolProfileBehavior
     */
...
module.exports = {
    ...
    getRequestOptions: function (request, defaultOpts, protocolProfileBehavior) {
        ...
        options.strictSSL = resolveWithProtocolProfileBehavior('strictSSL', defaultOpts, protocolProfileBehavior);

        // keeping the same convention as Newman
        // eslint-disable-next-line max-len
        options.followRedirect = resolveWithProtocolProfileBehavior('followRedirects', defaultOpts, protocolProfileBehavior);
        options.followAllRedirects = options.followRedirect;

        // redirect with the original HTTP method (default: redirects with GET)
        // eslint-disable-next-line max-len
        options.followOriginalHttpMethod = resolveWithProtocolProfileBehavior('followOriginalHttpMethod', defaultOpts, protocolProfileBehavior);

        // maximum number of redirects to follow (default: 10)
        options.maxRedirects = resolveWithProtocolProfileBehavior('maxRedirects', defaultOpts, protocolProfileBehavior);
        ...
        // eslint-disable-next-line max-len
        options.removeRefererHeader = resolveWithProtocolProfileBehavior('removeRefererHeaderOnRedirect', defaultOpts, protocolProfileBehavior);
