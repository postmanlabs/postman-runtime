var _ = require('lodash'),
    ...
    // any JS reserved keywords that need to be whitelisted as request body properties need to be added here
    SPECIAL_REQ_BODY_KEYS = {constructor: 'function'},
        ...
        if (mode === REQUEST_MODES.RAW) {
            ...
            computedBody = {
                form: _.reduce(content, function (accumulator, param) {
                    ...
                    if (accumulator[key] && (typeof accumulator[key] !== SPECIAL_REQ_BODY_KEYS[key])) {
