...
module.exports = {
    ...
    getRequestBody: function (request, options) {
        ...
        var requestBody = request.body,
            ...
            protocolProfileBehavior = requestBody.protocolProfileBehavior,
            disableBodyPruning = protocolProfileBehavior === 'disable-body-pruning';
        ...
        // bail out if request method doesn't support body and disableBodyPruning is not set.
        if (_.includes(METHODS_WITHOUT_BODY, requestMethod) && protocolProfileBehavior && !disableBodyPruning) {
            return;
        }
        ...
        if (requestMethod === GET && !disableBodyPruning && options && !options.sendBodyWithGetRequests) {
            return;
        }
