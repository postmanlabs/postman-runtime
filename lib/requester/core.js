...
module.exports = {
     ...
     * @param defaultOpts.removeRefererHeader
    ...
    getRequestOptions: function (request, defaultOpts) {
        ...
        options.followOriginalHttpMethod = defaultOpts.followOriginalHttpMethod;

        // maximum number of redirects to follow (default: 10)
        options.maxRedirects = defaultOpts.maxRedirects;
        ...
        options.removeRefererHeader = defaultOpts.removeRefererHeader;
