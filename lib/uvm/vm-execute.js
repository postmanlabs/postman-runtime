(function(universe) {
    ...
    for (i = 0; i < requires.length; i++) {
        ...
        try {
            // @todo: rely exclusively on required.noConflict being a function and use it
            required = __require(lib.require);
            libraries[lib.object] = lib.require === 'lodash3' ? required.noConflict() : required;
        }
        catch (e) {
