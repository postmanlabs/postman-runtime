...
(function (win) {
    ...
    // If we're running for the first time, create a list of all possible globals
    if (!Array.isArray(win.__js_globals)) {
        win.__js_globals = Object.keys(win);
    }
    ...
    Scope = function (replacements) {
        ...
        globals = win.__js_globals.slice(0);
