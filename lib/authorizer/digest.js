...
/**
 * `realm` and `nonce` should be stored and reused for Digest auth. If not found, a second request should be sent
 * using the values sent by the server. Also the previously stored `realm` and `nonce` should be discarded and
