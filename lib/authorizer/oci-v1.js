...
var convertToDomHeadersObject = function (postmanHeaders) {
    ...
    processRequestForOci = function (request, auth, callback) {
        ...
        if (!auth.get('forceDisableBodyHashing') && request.body && _.includes(EXTRA_HEADER_METHODS, uppercaseMethod)) {
        ...
        // NOTE: OCI needs 'authorization' but our version of httpSignature (1.3.1) puts signature in 'Authorization'
        // eslint-disable-next-line one-var
