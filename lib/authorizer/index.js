...
// Interface functions
/**
 * This hook returns a manifest that defines the nature of this auth. {@see AuthManifest} for more documentation.
 *
 * @function
 * @name AuthHandlerInterface#manifest
 *
 * @returns {AuthHandlerInterface~AuthManifest}
 */
...
/**
 * AuthManifest includes the name of the auth and the changes it can make to the request if any.
 *
 * @typedef {Object} AuthHandlerInterface~AuthManifest
 * @property {String} name Name to which this handler is registered.
 * @property {Object} updates An Object describing the parts of a request this handler can mutate.
 * @property {Boolean|Object} [updates.url]
 * @property {Boolean} [updates.url.auth]
 * @property {Boolean} [updates.url.hash]
 * @property {Array<String>} [updates.url.query]
 * @property {Boolean} [updates.method]
 * @property {Array<String>} [updates.header]
 * @property {Object} [updates.body]
 * @property {Array<String>} [updates.body.urlencoded]
 * @property {Object} [updates.auth]
 * @property {Array<String>} [updates.auth.noauth]
 * @property {Array<String>} [updates.auth.basic]
 * @property {Array<String>} [updates.auth.digest]
 * @property {Array<String>} [updates.auth.hawk]
 * @property {Array<String>} [updates.auth.awsv4]
 * @property {Array<String>} [updates.auth.oauth1]
 * @property {Array<String>} [updates.auth.oauth2]
 * @property {Array<String>} [updates.auth.ntlm]
 */
