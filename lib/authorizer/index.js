...
_.assign(Authorizer.prototype, {
    ...
    preVerify: function (context, run, callback) {
        ...
        Requester.create({
            ...
            handler.pre(context.item, context.coords, requester, callback);
        });
    },
    ...
    init: function (context, run, callback) {
        ...
        Requester.create({
            ...
            handler.init(context.item, context.coords, requester, callback);
        });
    },
    ...
    postVerify: function (context, run, callback) {
        ...
        Requester.create({
            ...
            handler.post(context.item, context.coords, context.response, requester, callback);
        });
    }
});
