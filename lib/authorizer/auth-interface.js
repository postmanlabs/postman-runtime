...
createAuthInterface = function (auth, authState, protocolProfileBehavior, options) {
    ...
    return /** @lends AuthInterface.prototype **/{
        ...
        /**
         * @param {String} type - type of auth
         * @return {AuthState|undefined}
         */
        getAuthState: function (type) {
            if (type && authState && authState[type]) {
        ...
        /**
         * @param {String} type - type of auth
         * @param {AuthState|undefined} value - auth state
         */
        setAuthState: function (type, value) {
            if (!authState || !type) {
                return;
            }

            authState[type] = value;
        }
    };
};
