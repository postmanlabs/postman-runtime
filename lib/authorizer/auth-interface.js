 ...
 * @param {Object} authorizer - authorizer options for this run
 * @return {AuthInterface}
 * @throws {Error}
 */
createAuthInterface = function (auth, protocolProfileBehavior, authorizer) {
    ...
    return /** @lends AuthInterface.prototype **/{
        ...
        get: function (keys) {
            ...
            if (_.isString(keys)) {
                ...
                if (keys === 'refreshTokenHelper') {
                    return authorizer && authorizer.refreshTokenHelper;
                }
            ...
            if (_.isArray(keys)) {
                return _.transform(keys, function (paramObject, key) {
                    if (key === 'refreshTokenHelper') {
                        paramObject[key] = authorizer && authorizer.refreshTokenHelper;
         ...
         * @param {*} [value] -
         * @param {Boolean} [isSystemParam] - Explicitly allow setting a param as a system param
         * @return {AuthInterface}
         * @example
         * set('foo', 'bar')
         ...
         * @throws {Error}
         */
        set: function (key, value, isSystemParam) {
            var modifiedParams = {},
                parameters;
