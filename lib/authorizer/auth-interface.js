 ...
 * @param {Object} requester - Run options for this run
 * @return {AuthInterface}
 * @throws {Error}
 */
createAuthInterface = function (auth, protocolProfileBehavior, requester) {
        ...
        get: function (keys) {
            ...
            if (_.isString(keys)) {
                ...
                if (keys === 'refreshTokenHelper') {
                    return requester.refreshTokenHelper;
                }
            ...
            if (_.isArray(keys)) {
                return _.transform(keys, function (paramObject, key) {
                    if (key === 'refreshTokenHelper') {
                        paramObject[key] = requester.refreshTokenHelper;
                    }
