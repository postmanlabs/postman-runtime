 ...
 * @param {Object} requesterOptions - Run options for this run
 * @return {AuthInterface}
 * @throws {Error}
 */
createAuthInterface = function (auth, protocolProfileBehavior, requesterOptions) {
        ...
        get: function (keys) {
            ...
            if (_.isString(keys)) {
                ...
                if (keys === 'refreshTokenHelper') {
                    return requesterOptions.refreshTokenHelper;
                }
            ...
            if (_.isArray(keys)) {
                return _.transform(keys, function (paramObject, key) {
                    if (key === 'refreshTokenHelper') {
                        paramObject[key] = requesterOptions.refreshTokenHelper;
