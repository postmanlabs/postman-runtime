/**
 * Requires a header param foreach akamai credential variable (baseURL, accessToken, clientToken, clientSecret).
 * These header keys can point to a postman environment variable.
*/
