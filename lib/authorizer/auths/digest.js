...
_.extend(Digest.prototype, {
    ...
    pre: function (item, run, requester, done) {
        ...
        if (!(_.every(Digest.DYNAMIC_PARAMETERS, _.partial(_.has, parameters)))) {
...
_.extend(Digest, {
    ...
    /**
     * List of parameters fetched dynamically by this auth method.
     *
     * @enum
     */
    DYNAMIC_PARAMETERS: ['realm', 'nonce'],
