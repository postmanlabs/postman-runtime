...
module.exports = {
    ...
    computeHeader: function (params) {
        var url = params.url,
            ...
            signature,
            accessor = {
                consumerSecret: helperParams.consumerSecret || EMPTY,
                tokenSecret: helperParams.tokenSecret || EMPTY,
                privateKey: helperParams.privateKey || EMPTY
            };
        ...
        signatureParams = [
            ...
            {system: true, key: OAUTH1_PARAMS.oauthCallback, value: helperParams.callback},
            {system: true, key: OAUTH1_PARAMS.oauthVerifier, value: helperParams.verifier}
        ];

        if (helperParams.bodyHash) {
            signatureParams.push({system: true, key: OAUTH1_PARAMS.oauthBodyHash, value: helperParams.bodyHash});
        }
    ...
    sign: function (auth, request, done) {
        var self = this,
            ...
            signRequest = function () {
                ...
                signatureParams = self.computeHeader({
        ...
        if (!params.consumerKey ||
            (signatureAlgo === HMAC && !params.consumerSecret) ||
