    ...
    manifest: function () {
        return {
            ...
            updates: {
                ...
                url: {
                    query: [
                        OAUTH1_PARAMS.oauthConsumerKey,
                        OAUTH1_PARAMS.oauthToken,
                        OAUTH1_PARAMS.oauthSignatureMethod,
                        OAUTH1_PARAMS.oauthTimestamp,
                        OAUTH1_PARAMS.oauthNonce,
                        OAUTH1_PARAMS.oauthVersion,
                        OAUTH1_PARAMS.oauthSignature
                    ]
                },
                body: {
                    urlencoded: [
