...
var _ = require('lodash'),
    ...
    /**
     * Pads the given number with '0' and returns a string with given length (or greater if number is already longer
     * than given length)
     *
     * @param {Number} num Number to pad
     * @param {Number} length Minimum length of the string to return
