...
module.exports = {
    ...
    pre: function (auth, done) {
        !auth.getAuthState(NTLM) && auth.setAuthState(NTLM, STATES.INITIALIZED);
    ...
    post: function (auth, response, done) {
        ...
        var state = auth.getAuthState(NTLM),
        ...
        if (state === STATES.INITIALIZED) {
            ...
            // Update the state
            auth.setAuthState(NTLM, STATES.T1_MSG_CREATED);
            ...
            auth.setAuthState(NTLM, STATES.T3_MSG_CREATED);
    ...
    sign: function (auth, request, done) {
        var ntlmHeader = auth.get(NTLM_HEADER),
            authState = auth.getAuthState(NTLM);
