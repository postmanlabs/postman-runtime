...
module.exports = {
    ...
    pre: function (auth, done) {
        !auth.getState(NTLM) && auth.setState(NTLM, STATES.INITIALIZED);
    ...
    post: function (auth, response, done) {
        ...
        if (state === STATES.INITIALIZED) {
            ...
            // Update the state
            auth.setState(NTLM, STATES.T1_MSG_CREATED);
            ...
            auth.setState(NTLM, STATES.T3_MSG_CREATED);
