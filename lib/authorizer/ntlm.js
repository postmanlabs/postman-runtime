...
module.exports = {
    ...
    post: function (auth, response, done) {
        ...
        if (state === STATES.INITIALIZED) {
            ...
            auth.set(NTLM_HEADER, typeOneMessage);
            ...
            typeTwoMessage = ntlmUtil.parseType2Message(response.headers.get(WWW_AUTHENTICATE) || EMPTY, _.noop);
            ...
            auth.set(NTLM_HEADER, typeThreeMessage);
