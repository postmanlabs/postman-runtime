...
module.exports = {
    ...
    sign: function (auth, request, done) {
        ...
        try {
            ...
            // Remove the algorithm from the header if it is present - treat
            // root level alg as source of truth.
            ...
            // payload must be a valid JSON string to avoid token error
            ...
            return jwt.sign(payload, signKey, { algorithm, header }, function (err, jwtToken) {
                if (err) {
                    return done(err);
                }
