...
function handleNestedRequest ({ executionId, isExecutionSkipped }) {
    ...
    return function (_cursor, eventId, requestId, requestToRunId, runRequestOptions = {}, runContext = {}) {
        ...
        requestResolver(requestToRunId, function (err, collection) {
            ...
            if (collectionVariables.values.length) {
                runnableCollection.variable = (runnableCollection.variable ||= [])
                    .concat(...collectionVariables.values);
            }
...
module.exports = handleNestedRequest;
