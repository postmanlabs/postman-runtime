...
_.assign(SshTunnelAgent.prototype, {
    ...
    createTunnel: function (sshConfig) {
        ...
        sshc.connect({
            ...
            privateKey: require('fs').readFileSync(sshConfig.auth.privateKeyPath)
        });
    ...
    getUrl: function(scope) {
        ...
        return (scope.state.items[coords.position].request.url.toString());
    }
});
