...
_.assign(Runner.prototype, {
     ...
     * @param {Number} [options.requestExecutionStack] - The execution stack defining the depth and parent chain
     * at which nested requests are executing. This is set by the parent runner when spinning up a recursive runner.
    ...
    run (collection, options, callback) {
        ...
        extractRunnableItems(collection, options.entrypoint, function (err, runnableItems, entrypoint) {
            ...
            return callback(null, (new Run({
                ...
                requestExecutionStack: options.requestExecutionStack,
