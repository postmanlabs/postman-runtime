...
_.assign(Runner.prototype, {
     ...
     * @param {String|Object} [options.entrypoint] Name or ID of the item-group to be run
     * @param {String} [options.entrypoint.type]
     * @param {Array<String>} [options.entrypoint.path]
