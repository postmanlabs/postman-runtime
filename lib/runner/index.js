...
_.assign(Runner.prototype, {
     ...
     * @param {Boolean} [options.nestedRequest.isNestedRequest] - Indicates this runner is for a nested request.
     ...
     * @param {Number} [options.nestedRequest.iterationCount] - The number of requests currently accummulated
     * by the nested request chain.
     * @param {Object} [options.requester] - Options specific to the requester
     * @param {Number} [options.requester.maxInvokableNestedRequest] - The maximum number of nested requests
