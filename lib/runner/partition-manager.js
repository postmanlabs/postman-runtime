...
class PartitionManager {
    ...
    _getSinglePartition (startIteration = 0, partitionSize = 1, partitionIndex = 0) {
        var Run = require('./run'),
            ...
            cursor = Cursor.box({
                length: _.get(this, 'state.items.length', 0),
                cycles: _.get(this, 'options.iterationCount', 0),
        ...
        return {
            ...
            cursor: cursor,
            variables: variables,
            startIndex: startIteration // start index for this partition in the overall cycles
        };
    }
