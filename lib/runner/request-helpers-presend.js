    ...
    function (context, run, done) {
        ...
        var auth = context.auth,
            ...
            authSignHook = function () {
                try {
                    authHandler.sign(authInterface, context.item.request, function (err) { done(err); });
                }
                catch (e) { done(e); }
            };
        ...
        authPreHook = function () {
            authHandler.pre(authInterface, function (err, success, request) {
                ...
                replayController.requestReplay(context, item, true, function (error, response) {
                    ...
                    authHandler.init(authInterface, response, function (err) {
                        if (err) { return done(err); }
