    ...
    function (context, run, done) {
        ...
        var auth = context.auth,
            ...
            authSignHook = function () {
                try {
                    authHandler.sign(authInterface, context.item.request, context.state, function (err) {
        ...
        authPreHook = function () {
            authHandler.pre(authInterface, context.state, function (err, success, request) {
