            ...
            new runner().run(runnableRefRequestCollection,
                ...
                function (err, run) {
                    ...
                    run.start({
                        ...
                        response (err, _, response, request, item, cookies, history) {
                            ...
                            itemForLogs = item;
                            historyForLogs = history;
                            cookiesForLogs = cookies;
                            ...
                            if (typeof self.triggers.request === 'function') {
                                self.triggers.request(err,
                                    self.state.nestedRequest.rootCursor,
