...
function runNestedRequest ({ executionId, isExecutionSkipped, vaultSecrets }) {
    ...
    return function (cursor, eventId, requestId, requestToRunId, runRequestOptions = {}, runContext = {}) {
        const self = this,
            ...
            // Checks for number of requests the invoker has run so far
            requestInvokedBy = requestExecutionStack && requestExecutionStack.length ?
                requestExecutionStack[0].executionId : executionId,
