var sdk = require('postman-collection'),
    ...
    lookupByMultipleIdOrName = function (collection, options, callback) {
        ...
        preserveOrder && items && items.members && Array.isArray(items.members) && items.members.sort(function (a, b) {
            // Getting the keys of the folder/request as lookups can be on the basis of either id or name.
            let key1 = entrypoints.indexOf(a.name),
                key2 = entrypoints.indexOf(b.name);

            key1 = (key1 === -1) ? entrypoints.indexOf(a.id) : key1;
            key2 = (key2 === -1) ? entrypoints.indexOf(b.id) : key2;
