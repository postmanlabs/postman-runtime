var sdk = require('postman-collection'),
    ...
    lookupByMultipleIdOrName = function (collection, options, callback) {
        ...
        // Sorting the items by the order in which they appear as folder arguments.
        items && items.members && items.members.sort(function (a, b) {
            return entrypoints.indexOf(a.name) - entrypoints.indexOf(b.name);
        });
