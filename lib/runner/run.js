...
_.assign(Run.prototype, {
    ...
    start (callback) {
        ...
        if (this.options.customParallelIterations) {
            // if custom parallel iterations is true, then set the max concurrency and iteration count to 1
        ...
        this.areIterationsParallelized = this.options.customParallelIterations || maxConcurrency > 1;
