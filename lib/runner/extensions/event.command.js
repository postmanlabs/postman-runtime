                ...
                this.host.execute(event, {
                    ...
                    if (visualiserResults) {
                        Visualiser.processTemplate(visualiserResults.template,
                            ...
                            function (err, processedTemplate, processedData) {
                                if (err) {
                                ...
                                visualiserResults.globals = processedData.globals;
                                visualiserResults.environment = processedData.environment;
                                visualiserResults.response = processedData.response;
                            });
                    }
