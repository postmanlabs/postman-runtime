                            ...
                            async function (err, collectionWithReqToRun) {
                                ...
                                const collectionRequestRunner = require('../../runner'),
                                    ...
                                    runnableCollection = new sdk.Collection({
                                        info: collectionWithReqToRun.info || {},
                                        item: [collectionWithReqToRun.item],
                                        variable: collectionWithReqToRun.variable ?
                                            collectionWithReqToRun.variable.map(function (variable) {
                                ...
                                // Merge global variables from parent & scope with any collection variables from parent
                                globals.values = [
                                    ...globals.values,
                                    ...collectionVariables.values
                                ];
