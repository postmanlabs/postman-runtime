...
module.exports = {
    init: function (done) {
        ...
        sandbox.createContext(_.merge({
            ...
            // We are having this triggerHandler wrapper to ensure the triggers are
            // not invoked for skipped executions.
            // Earlier we tried overriding the context.on method to not invoke the
            // triggers for skipped executions, but that was causing memory leaks
            // with execution.result handlers not getting removed for some unknown reasons.
            // TODO: Investigate the memory leak issue and remove this wrapper.
