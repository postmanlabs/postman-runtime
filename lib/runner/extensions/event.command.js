var _ = require('lodash'),
    ...
    COOKIE_STORE_FINDALL_METHOD = 'findCookies',
    ...
    allowProgrammaticCookieAccess, // fn
...
allowProgrammaticCookieAccess = function (cookieJar, fnName, args) {
    ...
    return cookieJar.allowProgrammaticAccess(domain);
};
            ...
            async.mapSeries(events, function (event, next) {
                ...
                this.host.on(EXECUTION_COOKIES_EVENT_BASE + executionId,
                    function (eventId, action, fnName, args) {
                        ...
                        if (!allowProgrammaticCookieAccess(cookieJar, fnName, args)) {
                            return self.host.dispatch(dispatchEvent, eventId, null,
                                fnName === COOKIE_STORE_FINDALL_METHOD ? [] : null);
                        }
