...
module.exports = {
    ...
    process: {
         ...
         *
         * @param {Function=} extractFailures - A function that extracts failures from a tests object.
         ...
         */
        event: function (extractFailures, payload, next) {
            // adjust for polymorphic instructions
            if (!next && _.isFunction(payload) && !_.isFunction(extractFailures)) {
                next = payload;
                payload = extractFailures;
