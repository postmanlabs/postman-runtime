                ...
                this.host.execute(event, {
                    ...
                    if (visualiserResults) {
                        Visualiser.processTemplate(visualiserResults.template,
                            ...
                            function (err, processedTemplate, templateContext) {
                                if (err) {
                                ...
                                // replace original data with actual data that is used to process template
                                visualiserResults.options.data = templateContext;
                            });
                    }
