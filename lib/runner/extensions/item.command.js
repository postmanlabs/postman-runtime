        ...
        item (callback, payload, next) {
            ...
            this.queueDelay(function () {
                ...
                this.queue('event', {
                    ...
                    console.log('### actual runtime speaking ### prereqExecutions', prereqExecutions);
                    if (shouldSkipExecution(prereqExecutions)) {
                        console.log('### actual runtime speaking ### skipping execution');

                        return callback && callback.call(this, null, {
                            prerequest: prereqExecutions
                        });
                    }
                    console.log('### actual runtime speaking ### not skipping execution');
