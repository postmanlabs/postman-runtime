...
module.exports = {
    ...
    process: {
        ...
        item (callback, payload, next) {
            ...
            // @note: Only generate UUID if ref doesn't exist to avoid redundant generation
            // (cursor constructor may have already generated one)
            // Using crypto.randomUUID() (Node.js native) instead of uuid package
            if (!coords.ref) {
