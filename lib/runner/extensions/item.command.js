...
module.exports = {
    ...
    process: {
        ...
        item: function (callback, payload, next) {
            // adjust for polymorphic isntructions
            ...
            this.queue('event', {
                ...
                // instead we bail out
                if (stopOnError && prereqExecutionError) {
                    this.triggers.item(null, coords, item); // @todo - should this trigger receive error?
                    return callback && callback(this, prereqExecutionError, {
                ...
                this.queue('request', {
                    ...
                    coords: coords
                }).done(function (response, request, legacyResponse, legacyRequest) {
                    ...
                    legacyRequest && (ctxTemplate.request = request);
                    ...
                    this.queue('event', {
                        ...
                        this.triggers.item(null, coords, item); // @todo - should this trigger receive error?
                        callback && callback.call(this, (stopOnError && testExecutionError) ? testExecutionError : null,
                            {
                                prerequest: prereqExecutions,
                                request: request,
                                response: response,
