            ...
            this.queueDelay(function () {
                ...
                this.queue('event', {
                    ...
                    if ((stopOnError || stopOnFailure) && prereqExecutionError) {
                        getNextItem(prereqExecutionError, this, coords, {prerequest: prereqExecutions},
                            function (err, options) {
                                // trigger an event saying that item has been processed
                                // @todo - should this trigger receive error?
                                this.triggers.item(null, coords, item, options.nextItem);
                                callback && callback.call(this, err, {coords: options.nextCoords});
                            }.bind(this));
                    }
                    ...
                    this.queue('request', {
                        ...
                        if ((stopOnError || stopOnFailure) && requestError) {
                            getNextItem(requestError, this, coords, {request: request},
                                function (err, options) {
                                    // trigger an event saying that item has been processed
                                    // @todo - should this trigger receive error?
                                    this.triggers.item(null, coords, item, options.nextItem);
                        ...
                        this.queue('event', {
                            ...
                            getNextItem(((stopOnError || stopOnFailure) && testExecutionError) ?
                                testExecutionError : null, this, coords, {
