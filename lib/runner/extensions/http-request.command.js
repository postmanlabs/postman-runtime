var _ = require('lodash'),
    async = require('async'),
    fastUUID = require('../../util/fast-uuid'),
...
module.exports = {
    ...
    process: {
        ...
        httprequest (payload, next) {
            ...
            // @note: Using fastUUID for internal event namespacing (no crypto syscall needed)
            _.set(context, 'coords.httpRequestId', payload.httpRequestId || fastUUID());
