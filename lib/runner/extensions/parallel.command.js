...
module.exports = {
    init: function (done) {
        ...
        this.partitions = this.partitionManager.partitions;
        // queue a parallel command for each of our partitions
        this.partitionManager.partitions.forEach((partition, index) => {
            const currentCursor = partition.cursor.current(),
    ...
    process: {
        ...
        parallel (payload, next) {
            ...
            coords.partitionIndex = partitionIndex;
            ...
            if (payload.stopRunNow) {
                ...
                this.state.cursor.seek(coords.position, coords.iteration);
