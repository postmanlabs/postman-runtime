...
module.exports = {
    ...
    prototype: /** @lends Run.prototype */ {
        ...
        pause: function (callback) {
            callback = backpack.ensure(callback);

            if (this.paused) { return callback && callback.call(callback, this, new Error('run: already paused')); }
        ...
        resume: function (callback) {
            ...
            if (!this.paused) { return callback && callback.call(callback, this, new Error('run: not paused')); }
    ...
    process: /** @lends Run.commands */ {
        ...
        abort: function (userback, payload, next) {
            ...
            // execute the userback sent as part of the command and do so in a try block to ensure it does not hamper
            // the process tick
            backpack.ensure(userback) && userback.call(this);
