var _ = require('lodash'),
    ...
    createContext = function (payload) {
        ...
        // get a reference to the Auth instance from the item, so any changes don't have to be synced back
        !context.auth && (context.auth = context.item.getAuth());

        // set parent of auth to request so that SDK can use it for variable resolution
        context.auth.setParent(context.originalItem);
