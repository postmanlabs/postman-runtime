var _ = require('lodash'),
    ...
    createContext = function (payload) {
        ...
        // keep track of no of replays of the request
        context.replayCount = context.replayCount || 0;
...
module.exports = {
    ...
    process: {
        ...
        request: function (payload, next) {
             ...
             * @property {Number} replayCount - Number of times request was replayed
             */
            ...
            async.applyEachSeries(prehelpers, context, self, function (err) {
                ...
                beforeRequest = function (err) {
                    replayCount === 0 && self.triggers.beforeRequest(err, payload.coords, item.request, payload.item, {
                        abort: function () {
                ...
                self.requester.create(context.trace || {
                    ...
                    xhr = requester.request(sendId, item.request, function (err, res, req, cookies) {
                        ...
                        async.applyEachSeries(posthelpers, context, self, function (err) {
                            var pload;
                            if (context.auth && replayCount <= context.auth.maxReplayCount && context.replay) {
