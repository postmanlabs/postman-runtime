...
module.exports = {
    init: function (done) {
        ...
        this.options.requester = this.options.requester || {};
        this.options.requester.timeout = _.isFinite(timeout) ? timeout : undefined;
        ...
        request: function (payload, next) {
            ...
            async.applyEachSeries(prehelpers, context, self, function (err) {
                ...
                Requester.create(context.trace || {
                    ...
                    xhr = requester.request(item, sendId, context.coords, function (err, res, req, cookies) {
                        err = err || null;
