var _ = require('lodash'),
    ...
    resolveVariables = function (context, payload) {
        ...
        if (urlString) {
            // @note this adds support resolving nested variables as URL parser don't support them well.
            urlString = sdk.Property.replaceSubstitutionsIn({url: urlString}, variableDefinitions);

            // Re-parse the URL from the resolved string
            item.request.url = new sdk.Url(urlString.url);
        }
