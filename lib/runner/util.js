 ...
 */
    ...
    processExecutionResult (options) {
        ...
        if (!executionError) {
            ...
            snr = module.exports.extractSNR(executions.prerequest);
            snr = module.exports.extractSNR(executions.test, snr);
        }

        if (!runnerOptions.disableSNR && snr.defined) {
            // prepare the snr lookup hash if it is not already provided
            !snrHash && (snrHash = module.exports.prepareLookupHash(items));
