var { Url, UrlMatchPatternList, VariableList, VariableScope } = require('postman-collection'),
...
module.exports = {
    ...
    getVariablesAccessibleInScripts (scope) {
        const { id, values } = scope,
            variables = values.filter((variable) => {
                return variable && variable._ && variable._.isAccessibleInScripts;
            });
