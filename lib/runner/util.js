...
module.exports = {
    ...
    // streaming iteration data exposes a lazy row accessor instead of an array
        if (data && typeof data.getIterationRow === 'function') {
            return data.getIterationRow(iteration);
        }
