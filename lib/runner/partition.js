...
class Partition {
    ...
    constructor (runInstance, startIteration, partitionSize, partitionIndex) {
        ...
        // Generation tag for customParallelIterations slot reuse. Bumped each
        // time stopSinglePartition recycles this index; stamped onto queued
        // executions so a late in-flight completion from a PREVIOUS occupant
        // (arriving after the slot was reused and `stopped` was cleared) is
        // dropped by updatePartitionVariables instead of overwriting the new VU.
        this.generation = 0;
